...
Most components of the stack (Matrix/Synapse, Element Call, Visio DINUM, SeaweedFS, Seafile, OnlyOffice Document Server, Vikunja, Keycloak, Gokapi, the notification center, the unified search service, PeerTube, Caddy) is packaged as containers (Docker), which allows:
